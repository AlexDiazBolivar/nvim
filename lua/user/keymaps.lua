...
-- Signify
keymap("n", "<leader>hp", ":SignifyHunkDiff<CR>", opts)
keymap("n", "<leader>hd", ":SignifyDiff<CR>", opts)
keymap("n", "]c", "<plug>(signify-next-hunk):SignifyHunkDiff<CR>", opts)
keymap("n", "[c", "<plug>(signify-prev-hunk):SignifyHunkDiff<CR>", opts)
